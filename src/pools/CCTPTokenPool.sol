...
contract CCTPTokenPool is TokenPoolBase {
    using SafeERC20 for IERC20;

    /* ----------------------------- Errors -------------------------------- */

    error NotSupportedFunction(string functionName);
    ...
    function crossChainContractCall(
        ...
        override
    {
        revert NotSupportedFunction("crossChainContractCall");
    }
    ...
    function crossChainContractCallWithAsset(
        ...
        override
    {
        revert NotSupportedFunction("crossChainContractCallWithAsset");
    }
